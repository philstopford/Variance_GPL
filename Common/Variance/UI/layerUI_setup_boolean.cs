...
public partial class MainForm
{
    ...
    private void boolean_table(TableLayout layerBoolean_table)
    {
        // Outer table, row 1
        TableRow boolean_tr0 = new();
    ...
    private void boolean_row0(TableLayout row0_tl)
    {
        row0_tl.Rows.Add(new TableRow());
        ...
        for (int rb = 1; rb < CentralProperties.maxLayersForMC; rb++)
        {
            ...
            TableCell tc0 = new() {Control = rB_BooleanA[button]};
    ...
    private void boolean_row1(TableLayout row1_tl)
    {
        row1_tl.Rows.Add(new TableRow());
    ...
    private void boolean_row2(TableLayout row2_tl)
    {
        row2_tl.Rows.Add(new TableRow());
        ...
        for (int rb = 1; rb < CentralProperties.maxLayersForMC; rb++)
        {
            ...
            TableCell tc0 = new() {Control = rB_BooleanB[button]};
    ...
    private void boolean_row3(TableLayout row3_tl)
    {
        row3_tl.Rows.Add(new TableRow());
