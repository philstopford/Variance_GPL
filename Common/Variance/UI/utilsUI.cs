...
namespace Variance
{
    public partial class MainForm : Form
    {
        ...
        void settings_utilsUISetup()
        {
            ...
            Panel row0Panel = new Panel {Content = row0tl};
            ...
            Panel row1Panel = new Panel {Content = row1tl};
        ...
        void email_settings_utilsUISetup(TableCell tc)
        {
            ...
            TableLayout row0tl = new TableLayout();
            Panel row0 = new Panel {Content = row0tl};
            ...
            TableLayout row1tl = new TableLayout();
            Panel row1 = new Panel {Content = row1tl};
            ...
            Panel row2 = new Panel {Content = row2tl};
            ...
            Panel row3 = new Panel {Content = row3tl};
            ...
            Panel row4 = new Panel {Content = row4tl};
        ...
        void openGLRow0(TableCell tc)
        {
            ...
            Panel zoomPnl = new Panel {Content = zoomTL};
        ...
        void rng_customMappingSetup(TableCell tc)
        {
            ...
            Panel btnRow = new Panel {Content = btnTL};
