...
namespace Variance
{
    public partial class MainForm
    {
        ...
        void litho_icr_ocr(TableLayout lithography_table)
        {
            ...
            Panel outer = new Panel {Content = outer_tl};
            ...
            GroupBox groupBox_rounding = new GroupBox {Text = "Rounding"};
            // Table layout within cell.
            TableCell leftCol_tc = new TableCell {Control = groupBox_rounding};
            ...
            */
            ...
            TableCell rightCol_tc = new TableCell {Control = groupBox_misc};
        ...
        void litho_lwr(TableLayout lithography_table)
        {
            ...
            Panel outer = new Panel {Content = tl};
            GroupBox outer_gb = new GroupBox {Text = "LWR", Content = outer};

            lit_lwr.Cells.Add(new TableCell { Control = outer_gb });

            TableLayout left_tl = new TableLayout();
            left_tl.Rows.Add(new TableRow());
            Panel leftPnl = new Panel {Content = left_tl};
            ...
            Panel rightPnl = new Panel {Content = gB_LWRCorrelation};
            ...
            TableCell rB_CLWR_0tc = new TableCell {Control = rB_CLWR[0]};
            ...
            for (int rb = 1; rb < CentralProperties.maxLayersForMC; rb++)
            {
                ...
                TableCell tc0 = new TableCell {Control = rB_CLWR[rB_CLWR_]};
        ...
        void litho_lwr2(TableLayout lithography_table)
        {
            ...
            GroupBox outer_gb = new GroupBox {Content = outer, Text = "LWR2"};
            ...
            Panel rightPnl = new Panel {Content = gB_LWR2Correlation};
            ...
            TableCell rB_CLWR2_0tc = new TableCell {Control = rB_CLWR2[0]};
            ...
            for (int rb = 1; rb < CentralProperties.maxLayersForMC; rb++)
            {
                ...
                TableCell tc0 = new TableCell {Control = rB_CLWR2[rB_CLWR_]};
        ...
        void litho_scdu(TableLayout lithography_table)
        {
            ...
            GroupBox outer_gb = new GroupBox {Text = "Side CDU", Content = outer};
            ...
            TableCell rB_CCDU_0tc = new TableCell {Control = rB_CCDU[0]};
            ...
            for (int rb = 1; rb < CentralProperties.maxLayersForMC; rb++)
            {
                ...
                TableCell tc0 = new TableCell {Control = rB_CCDU[rB_CCDU_]};
        ...
        void litho_tcdu(TableLayout lithography_table)
        {
            ...
            GroupBox outer_gb = new GroupBox {Text = "Tips CDU", Content = outer};
            TableLayout tc_tl = new TableLayout();
            outer_tl.Rows.Add(new TableRow());
            outer_tl.Rows[0].Cells.Add(new TableCell { Control = tc_tl });
            tc_tl.Rows.Add(new TableRow());
            ...
            Panel p = new Panel();
            TableCell tc_1 = new TableCell {Control = p};
            ...
            TableCell ptc = new TableCell {Control = gB_TipCDUCorrelation};
            ptl.Rows[0].Cells.Add(ptc);
            ...
            TableCell rB_CTCDU_0tc = new TableCell {Control = rB_CTCDU[0]};
            ...
            for (int rb = 1; rb < CentralProperties.maxLayersForMC; rb++)
            {
                ...
                TableCell tc0 = new TableCell {Control = rB_CTCDU[rB_CTCDU_]};
        ...
        void litho_xol(TableLayout lithography_table)
        {
            TableLayout outer_tl = new TableLayout();
            Panel outer = new Panel {Content = outer_tl};
            GroupBox outer_gb = new GroupBox {Text = "Horizontal Overlay", Content = outer};
            outer_tl.Rows.Add(new TableRow());
            ...
            Panel left = new Panel {Content = left_tl};
            Panel mid = new Panel {Content = mid_tl};
            Panel right = new Panel {Content = right_tl};
            ...
            TableCell rB_OLRX_0tc = new TableCell {Control = rB_OLRX[0]};
            ...
            for (int rb = 1; rb < CentralProperties.maxLayersForMC; rb++)
            {
                ...
                TableCell tc0 = new TableCell {Control = rB_OLRX[rB_OLRX_]};
            ...
            for (int cb = 0; cb < CentralProperties.maxLayersForMC; cb++)
            {
                ...
                TableCell tc0 = new TableCell {Control = cB_OLRX_Av[cb]};
            ...
            TableCell right_tc = new TableCell {Control = pnl_overlayRefX};
            ...
            TableCell right_tc2 = new TableCell {Control = gB_overlayXCorrelation};
            ...
            TableCell rB_COLX_0tc = new TableCell {Control = rB_COLX[0]};
            ...
            for (int rb = 1; rb < CentralProperties.maxLayersForMC; rb++)
            {
                ...
                TableCell tc0 = new TableCell {Control = rB_COLX[rB_COLX_]};
        ...
        void litho_yol(TableLayout lithography_table)
        {
            TableLayout outer_tl = new TableLayout();
            Panel outer = new Panel {Content = outer_tl};
            GroupBox outer_gb = new GroupBox {Text = "Vertical Overlay", Content = outer};
            outer_tl.Rows.Add(new TableRow());
            ...
            TableCell rB_layer_OLRY_0tc = new TableCell {Control = rB_OLRY_exp[0]};
            ...
            for (int rb = 1; rb < CentralProperties.maxLayersForMC; rb++)
            {
                ...
                TableCell tc0 = new TableCell {Control = rB_OLRY_exp[rB_OLRY]};
            ...
            for (int cb = 0; cb < CentralProperties.maxLayersForMC; cb++)
            {
                ...
                TableCell tc0 = new TableCell {Control = cB_layer_OLRY_Av[cb]};
            ...
            TableCell right_tc = new TableCell {Control = pnl_overlayRefY};
            right_tl.Rows[^1].Cells.Add(right_tc);
            ...
            TableCell rB_COLY_0tc = new TableCell {Control = rB_COLY[0]};
            ...
            for (int rb = 1; rb < CentralProperties.maxLayersForMC; rb++)
            {
                ...
                TableCell tc0 = new TableCell {Control = rB_COLY[rB_COLY_]};
