...
namespace Variance
{
    public partial class MainForm
    {
        ...
        void twoD_DOEUISetup_tileset(TableCell tc)
        {
            ...
            TableLayout masterTable = new TableLayout();
            masterTable.Rows.Add(new TableRow());
            Panel p = new Panel {Content = masterTable};
            groupBox_tileSubSet.Content = p;

            TableLayout groupBox_tileSubSet_table = new TableLayout();
            Panel p0 = new Panel {Content = groupBox_tileSubSet_table};
            ...
            Panel row0 = new Panel {Content = row0_tl};
            ...
            Panel row1 = new Panel {Content = row1_tl};
            ...
            Panel row2 = new Panel {Content = row2_tl};
            ...
            Panel row3 = new Panel {Content = row3_tl};
            ...
            Panel row4 = new Panel {Content = row4_tl};
