...
{
    private void layerColorChange(Label id, Color colDialogColor)
    {
        Application.Instance.Invoke(() =>
        {
            ...
            if (id == lbl_axisColor)
            {
                varianceContext.vc.colors.axis_Color = UIHelper.colorToMyColor(colDialogColor);
            }
            if (id == lbl_vpbgColor)
            {
    ...
    private void layerColorChange(object sender, EventArgs e)
    {
        if (colUIFrozen)
        {
            return;
        ...
        try
        {
            ...
            {
                sourceColor = UIHelper.myColorToColor(varianceContext.vc.colors.axis_Color);
            }
    ...
    private void preferencesChange(object sender, EventArgs e)
    {
        if (utilsUIFrozen)
        {
            return;
