...
namespace Variance
{
    public partial class MainForm : Form
    {
        ...
        void oneDTabSetup()
        {
            ...
            tab_1DCalc_table.Rows[tab_1DCalc_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = TableLayout.AutoSized(lbl_1D_Guidance, centered: true) });

            Panel oneDLayers_pnl = new Panel();
            tab_1DCalc_table.Rows.Add(new TableRow());
            tab_1DCalc_table.Rows[tab_1DCalc_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = TableLayout.AutoSized(oneDLayers_pnl, centered: true) });

            oneDLayers_setup(ref oneDLayers_pnl);

            Panel minIns_pnl = new Panel();
            tab_1DCalc_table.Rows.Add(new TableRow());
            tab_1DCalc_table.Rows[tab_1DCalc_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = minIns_pnl });
            ...
            minIns_table.Rows[minIns_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_minins });

            text_minins = new TextBox();
            text_minins.Width = oneDMinInsWidth;
            minIns_table.Rows[minIns_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_minins });
            text_minins.LostFocus += oneDEventHandler;
            minIns_table.Rows[minIns_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = null }); // padding.

            // Image
            Panel oneDImagePanel = new Panel();
            ImageView oneDImage = new ImageView();
            oneDImage.Image = resources.images.oneDImage();
            oneDImagePanel.Size = oneDImage.Image.Size;
            oneDImagePanel.Content = oneDImage;
            tab_1DCalc_table.Rows.Add(new TableRow());
            tab_1DCalc_table.Rows[tab_1DCalc_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = TableLayout.AutoSized(oneDImagePanel, centered: true) });
            ...
            tab_1DCalc_table.Rows[tab_1DCalc_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = TableLayout.AutoSized(results_panel, centered: true) });
            ...
            groupBox_results_1D_table.Rows[groupBox_results_1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = left0 });
            groupBox_results_1D_table.Rows[groupBox_results_1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = right0 });
            ...
            l0_tl.Rows[l0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_threeSigmaEdgeTol1D_prefix });

            lbl_threeSigmaEdgeTol1D = new Label();
            lbl_threeSigmaEdgeTol1D.Text = "Sigma Edge Tolerance";

            l0_tl.Rows[l0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_threeSigmaEdgeTol1D });

            text_threeSigmaEdgeTol1D = new TextBox();
            text_threeSigmaEdgeTol1D.Width = 100;
            text_threeSigmaEdgeTol1D.ReadOnly = true;
            l0_tl.Rows[l0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_threeSigmaEdgeTol1D });
            ...
            l0_tl.Rows[l0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_fourSigmaEdgeTol1D_prefix });

            lbl_fourSigmaEdgeTol1D = new Label();
            lbl_fourSigmaEdgeTol1D.Text = "Sigma Edge Tolerance";

            l0_tl.Rows[l0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_fourSigmaEdgeTol1D });

            text_fourSigmaEdgeTol1D = new TextBox();
            text_fourSigmaEdgeTol1D.Width = 100;
            text_fourSigmaEdgeTol1D.ReadOnly = true;
            l0_tl.Rows[l0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_fourSigmaEdgeTol1D });
            ...
            l0_tl.Rows[l0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = input_nsigma1D });

            lbl_sigmaEdgeTol1D = new Label();
            lbl_sigmaEdgeTol1D.Text = "Sigma Edge Tolerance";

            l0_tl.Rows[l0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_sigmaEdgeTol1D });

            text_nSigmaEdgeTol1D = new TextBox();
            text_nSigmaEdgeTol1D.Width = 100;
            text_nSigmaEdgeTol1D.ReadOnly = true;
            l0_tl.Rows[l0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_nSigmaEdgeTol1D });
            ...
            r0_tl.Rows[r0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_threeSigmaRule1D_prefix });

            lbl_threeSigmaRule1D = new Label();
            lbl_threeSigmaRule1D.Text = "Sigma Rule";
            r0_tl.Rows[r0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_threeSigmaRule1D });

            text_threeSigmaRule1D = new TextBox();
            text_threeSigmaRule1D.Width = 100;
            text_threeSigmaRule1D.ReadOnly = true;
            r0_tl.Rows[r0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_threeSigmaRule1D });
            ...
            r0_tl.Rows[r0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_fourSigmaRule1D_prefix });

            lbl_fourSigmaRule1D = new Label();
            lbl_fourSigmaRule1D.Text = "Sigma Rule";
            r0_tl.Rows[r0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_fourSigmaRule1D });

            text_fourSigmaRule1D = new TextBox();
            text_fourSigmaRule1D.Width = 100;
            text_fourSigmaRule1D.ReadOnly = true;
            r0_tl.Rows[r0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_fourSigmaRule1D });
            ...
            r0_tl.Rows[r0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_nSigmaRule1D_prefix });

            lbl_nSigmaRule1D = new Label();
            lbl_nSigmaRule1D.Text = "Sigma Rule";
            r0_tl.Rows[r0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_nSigmaRule1D });

            text_nSigmaRule1D = new TextBox();
            text_nSigmaRule1D.Width = 100;
            text_nSigmaRule1D.ReadOnly = true;
            r0_tl.Rows[r0_tl.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_nSigmaRule1D });
        ...
        void oneDLayer1_setup(TableLayout groupBox_layerOne1D_table)
        {
            ...
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerOneName, ScaleWidth = true });

            text_layerOneName = new TextBox();
            text_layerOneName.Width = 100;
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerOneName });
            ...
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerOneOverlayX, ScaleWidth = true });

            text_layerOneOverlayX = new TextBox();
            text_layerOneOverlayX.Width = 100;
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerOneOverlayX });
            ...
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerOneOverlayY, ScaleWidth = true });

            text_layerOneOverlayY = new TextBox();
            text_layerOneOverlayY.Width = 100;
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerOneOverlayY });
            ...
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerOneCDU, ScaleWidth = true });

            text_layerOneCDU = new TextBox();
            text_layerOneCDU.Width = 100;
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerOneCDU });
            ...
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerOneLWR, ScaleWidth = true });

            text_layerOneLWR = new TextBox();
            text_layerOneLWR.Width = 100;
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerOneLWR });
            ...
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerOneAddVar, ScaleWidth = true });

            text_layerOneAddVar = new TextBox();
            text_layerOneAddVar.Width = 100;
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerOneAddVar });
            ...
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerOneBias, ScaleWidth = true });

            text_layerOneBias = new TextBox();
            text_layerOneBias.Width = 100;
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerOneBias });
            ...
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerOneDrawn, ScaleWidth = true });

            text_layerOneDrawn = new TextBox();
            text_layerOneDrawn.Width = 100;
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerOneDrawn });
            ...
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerOnePhys, ScaleWidth = true });

            text_layerOnePhys = new TextBox();
            text_layerOnePhys.Width = 100;
            text_layerOnePhys.ReadOnly = true;
            groupBox_layerOne1D_table.Rows[groupBox_layerOne1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerOnePhys });
        }
        ...
        void oneDLayer2_setup(TableLayout groupBox_layerTwo1D_table)
        {
            ...
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerTwoName, ScaleWidth = true });

            text_layerTwoName = new TextBox();
            text_layerTwoName.Width = 100;
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerTwoName });
            ...
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerTwoOverlayX, ScaleWidth = true });

            text_layerTwoOverlayX = new TextBox();
            text_layerTwoOverlayX.Width = 100;
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerTwoOverlayX });
            ...
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerTwoOverlayY, ScaleWidth = true });

            text_layerTwoOverlayY = new TextBox();
            text_layerTwoOverlayY.Width = 100;
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerTwoOverlayY });
            ...
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerTwoCDU, ScaleWidth = true });

            text_layerTwoCDU = new TextBox();
            text_layerTwoCDU.Width = 100;
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerTwoCDU });
            ...
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerTwoLWR, ScaleWidth = true });

            text_layerTwoLWR = new TextBox();
            text_layerTwoLWR.Width = 100;
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerTwoLWR });
            ...
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerTwoAddVar, ScaleWidth = true });

            text_layerTwoAddVar = new TextBox();
            text_layerTwoAddVar.Width = 100;
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerTwoAddVar });
            ...
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerTwoBias, ScaleWidth = true });

            text_layerTwoBias = new TextBox();
            text_layerTwoBias.Width = 100;
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerTwoBias });
            ...
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerTwoDrawn, ScaleWidth = true });

            text_layerTwoDrawn = new TextBox();
            text_layerTwoDrawn.Width = 100;
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerTwoDrawn });
            ...
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = lbl_layerTwoPhys, ScaleWidth = true });

            text_layerTwoPhys = new TextBox();
            text_layerTwoPhys.Width = 100;
            text_layerTwoPhys.ReadOnly = true;
            groupBox_layerTwo1D_table.Rows[groupBox_layerTwo1D_table.Rows.Count - 1].Cells.Add(new TableCell() { Control = text_layerTwoPhys });
        }
