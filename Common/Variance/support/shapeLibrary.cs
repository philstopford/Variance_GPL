...
public class ShapeLibrary
{
    ...
    private EntropyLayerSettings layerSettings;
    ...
    private void pShapeLibrary(EntropyLayerSettings mcLayerSettings)
    {
        shapeValid = false;
        layerSettings = mcLayerSettings;
    }

    public ShapeLibrary(int shapeIndex_, EntropyLayerSettings mcLayerSettings)
    {
        pShapeLibrary(shapeIndex_, mcLayerSettings);
    }

    private void pShapeLibrary(int shapeIndex_, EntropyLayerSettings mcLayerSettings)
    {
        ...
        try
        {
            ...
            switch (shapeIndex)
            {
                ...
                case (int)CommonVars.shapeNames.Sshape:
                    Sshape();
                    break;
                case (int)CommonVars.shapeNames.GEOCORE:
    ...
    private void configureArrays()
    {
        ...
        switch (shapeIndex)
        {
            case (int)CommonVars.shapeNames.rect: // rectangle
                vertexCount = 9;
                break;
            case (int)CommonVars.shapeNames.Lshape: // L
                vertexCount = 13;
                break;
            case (int)CommonVars.shapeNames.Tshape: // T
                vertexCount = 17;
                break;
            case (int)CommonVars.shapeNames.Xshape: // Cross
                vertexCount = 25;
                break;
            case (int)CommonVars.shapeNames.Ushape: // U
                vertexCount = 17;
                break;
            case (int)CommonVars.shapeNames.Sshape: // S
                vertexCount = 25;
                break;
        }
    ...
    private void Sshape()
    {
        ...
        tmpY -= Convert.ToDouble(layerSettings.getDecimal(EntropyLayerSettings.properties_decimal.s2VerOffset)) / 2;
        Vertex[13] = new MyVertex(tmpX, tmpY, typeDirection.right1, true, false, typeVertex.center);
        // Center so no rounding definition
    ...
    private void customShape_orthogonal(GeoLibPointF[] sourcePoly)
    {
        ...
        if (layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.L ||
            layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.LR ||
            layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.BL ||
            layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TL ||
            layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TBL ||
            layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.BLR ||
            layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TLR ||
            layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.all)
        {
        ...
        for (int pt = 1; pt < roundCount - 1; pt++)
        {
            ...
            if (!vertical)
            {
                if (up)
                {
                    ...
                    if (layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.T ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TB ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TL ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TR ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TBL ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TBR ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TLR ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.all)
                    {
                        tips[vertexCounter] = true;
                ...
                else
                {
                    ...
                    if (layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.B ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TB ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.BL ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.BR ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TBL ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TBR ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.BLR ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.all)
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.R ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.LR ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.BR ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TR ||
                        layerSettings.getInt(EntropyLayerSettings.properties_i.shape0Tip) == (int)CommonVars.tipLocations.TBR ||
