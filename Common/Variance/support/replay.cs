...
public class Replay
{
    ...
    private ChaosSettings pGetChaosSettings()
    {
    ...
    private CommonVars commonVars_;
    private List<string[]> parsed;
    private int max;
    private string listOfSettingsHash, entropyGeoHash, geoCoreHash;
    private int col, row; // for tile extraction.
    ...
    private void pReplay(ref CommonVars commonVars)
    {
    ...
    private void pLoadCSV(string filename)
    {
        try
        {
    ...
    private void pGetState(int index)
    {
        // Compare the hashes with the loaded project.
